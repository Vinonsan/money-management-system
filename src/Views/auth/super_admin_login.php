...
<?php if ($step === 'otp'): ?>
    <form method="post" action="<?= BASE_URL ?>/super-admin/login/verify-otp" class="space-y-5"
        ...
        <button type="submit" id="verify-btn"
                class="w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-2.5 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed">
            Verify &amp; Login
        </button>
