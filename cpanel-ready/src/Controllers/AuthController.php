...
{
    public function redirectToAdminLogin(): void
    {
        header('Location: ' . BASE_URL . '/admin/login', true, 302);
        exit;
    }
    ...
    public function showLogin(): void
    {
        ...
        renderAuthLayout('Admin Login', __DIR__ . '/../Views/auth/login.php', [
    ...
    public function requestOtp(): void
    {
        ...
        if ($user['role'] !== 'admin') {
            $this->flashError('This portal is only for Administrators.');
            $_SESSION['otp_step'] = 'phone';
            $_SESSION['otp_phone'] = $phone;
            $this->redirectLogin();
        }
